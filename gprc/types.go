...
func newTxResponseCheckTx(res *BroadcastTxCommitResult) *sdk.TxResponse {
	...
	return &sdk.TxResponse{
		...
		Events:    utils.Map(res.CheckTx.Events, utils.ConvertCometBFTEventToTendermintEvent),
	}
}
...
func newTxResponseDeliverTx(res *BroadcastTxCommitResult) *sdk.TxResponse {
	...
	return &sdk.TxResponse{
		...
		Events:    utils.Map(res.DeliverTx.Events, utils.ConvertCometBFTEventToTendermintEvent),
	}
}
