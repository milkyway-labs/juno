...
func MustCreateGrpcConnection(cfg *Details, cdc codec.ProtoCodec) grpc.ClientConnInterface {
...
func CreateGrpcConnection(cfg *Details, cdc codec.ProtoCodec) (grpc.ClientConnInterface, error) {
