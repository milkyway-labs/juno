...
import (
	...
	types1 "github.com/forbole/juno/v5/cosmos-sdk/types"
	_ "github.com/forbole/juno/v5/cosmos-sdk/types/tx/amino"
	signing "github.com/forbole/juno/v5/cosmos-sdk/types/tx/signing"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type TxBody struct {
	...
	// https://github.com/forbole/juno/v5/cosmos-sdk/issues/9122).
...
type Fee struct {
	...
	Amount github_com_forbole_juno_v5_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/forbole/juno/v5/cosmos-sdk/types.Coins" json:"amount"`
...
func (m *Fee) GetAmount() github_com_forbole_juno_v5_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *Tip) GetAmount() github_com_forbole_juno_v5_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
